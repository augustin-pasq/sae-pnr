...
SELECT Obs_GCI.*, nomPlage, raisonArretObservation, nbEnvol, protection,
    bagueMale, bagueFemelle, dateObs, heureObs, lieu_Lambert_X, lieu_Lambert_Y
FROM Obs_GCI
...
SELECT Obs_Batracien.*, zh_temporaire, zh_profondeur, zh_surface, zh_typeMare, zh_pente, zh_ouverture,
        natureVege, vegetation, decrit_LieuVege, dateObs, heureObs, lieu_Lambert_X, lieu_Lambert_Y
    FROM Obs_Batracien
